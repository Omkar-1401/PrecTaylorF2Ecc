...
subst['exec_prefix'] = Template('${prefix}').substitute(**subst)
BINDIR = Path(Template('${exec_prefix}/bin').substitute(**subst))
DATADIR = Path(Template('$prefix/share').substitute(**subst))
PYTHONDIR = Path(Template('${PYTHON_PREFIX}/lib/python3.13/site-packages').substitute(**subst))
BASE_VERSION = '7.26.2'
NIGHTLY_VERSION = ''
