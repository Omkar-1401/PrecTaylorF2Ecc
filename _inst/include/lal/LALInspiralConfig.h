/* lib/LALInspiralConfig.h.  Generated from LALInspiralConfig.h.in by configure.  */
/* only include this file if LALInspiral's config.h has not been included */
#ifndef LALINSPIRAL_VERSION

/* LALInspiral Version */
#define LALINSPIRAL_VERSION "5.0.3.1"

/* LALInspiral Version Major Number  */
#define LALINSPIRAL_VERSION_MAJOR 5

/* LALInspiral Version Minor Number  */
#define LALINSPIRAL_VERSION_MINOR 0

/* LALInspiral Version Micro Number  */
#define LALINSPIRAL_VERSION_MICRO 3

/* LALInspiral Version Devel Number  */
#define LALINSPIRAL_VERSION_DEVEL 1
